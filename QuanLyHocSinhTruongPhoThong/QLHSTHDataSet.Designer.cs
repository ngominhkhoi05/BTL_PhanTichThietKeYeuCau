...
namespace QuanLyHocSinhTruongPhoThong.QLHSTHDataSetTableAdapters {
    ...
    public partial class RoleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Role] SET [RoleName] = @RoleName, [Description] = @Description WHERE (([RoleId] = @Original_RoleId) AND ([RoleName] = @Original_RoleName) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)));
SELECT RoleId, RoleName, Description FROM Role WHERE (RoleId = @RoleId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QuanLyHocSinhTruongPhoThong.Properties.Settings.Default.QLHSTHConnectionString;
        }
        ...
        public virtual int Fill(QLHSTHDataSet.RoleDataTable dataTable) {
        ...
        public virtual QLHSTHDataSet.RoleDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLHSTHDataSet.RoleDataTable dataTable = new QLHSTHDataSet.RoleDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLHSTHDataSet.RoleDataTable dataTable) {
